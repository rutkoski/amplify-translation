@extends('amplify-translation::super_layout')
	...
	<nav class="col-xs-12 col-sm-3">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h5>{{ trans('amplify-translation::panel.welcome.availableFiles') }}</h5>
			</div>
			<div class="panel-body">
				@include('amplify-translation::files_list', ['groups' => $groups, 'indent' => 0])
			</div>
   			@if($canManage)
				<div class="panel-footer">
					@include('amplify-translation::menu_actions')
				</div>
			@endif
		</div>                 
	</nav>
